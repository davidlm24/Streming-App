        ...
        <div className="p-6 overflow-y-auto space-y-6">
          ...
          <div className="bg-[var(--surface)] border border-[var(--line)] rounded-2xl p-4 space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <label className={`flex items-center gap-2 p-3 rounded-xl border cursor-pointer transition-all ${method === 'card' ? 'border-blue-500 bg-blue-500/10 text-white' : 'border-[var(--line)] bg-[var(--bg)] text-[var(--text-lo)] hover:text-white'}`}>
              ...
              <label className={`flex items-center gap-2 p-3 rounded-xl border cursor-pointer transition-all ${method === 'pix' ? 'border-blue-500 bg-blue-500/10 text-white' : 'border-[var(--line)] bg-[var(--bg)] text-[var(--text-lo)] hover:text-white'}`}>
              ...
              <label className={`flex items-center gap-2 p-3 rounded-xl border cursor-pointer transition-all ${method === 'paypal' ? 'border-blue-500 bg-blue-500/10 text-white' : 'border-[var(--line)] bg-[var(--bg)] text-[var(--text-lo)] hover:text-white'}`}>
