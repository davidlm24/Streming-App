    ...
    <div className="bg-[var(--surface)] border border-[var(--line)] p-6 rounded-2xl text-left space-y-6 shadow-xl">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-[var(--line)] pb-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className={`p-2 rounded-lg border border-[var(--line)] text-[var(--ink-lo)] hover:text-white transition-all text-xs cursor-pointer ${
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-[var(--bg)] border border-[var(--line)]/90 p-4 rounded-xl text-left space-y-1">
          <div className="flex items-center justify-between text-[var(--ink-lo)]">
          ...
          <div className="flex items-baseline gap-2 mt-1">
            ...
            <span className="text-[10px] text-[var(--ink-dim)] font-mono">4 Cores vCPU</span>
          </div>
        ...
        <div className="bg-[var(--bg)] border border-[var(--line)]/90 p-4 rounded-xl text-left space-y-1">
          ...
          <div className="flex items-baseline gap-2 mt-1">
            ...
            <span className="text-[10px] text-[var(--ink-dim)] font-mono">/ 8.00 GB ({currentMemory}%)</span>
          </div>
          <div className="w-full bg-[var(--surface)] h-1.5 rounded-full overflow-hidden mt-2">
            <div 
        ...
        <div className="bg-[var(--bg)] border border-[var(--line)]/90 p-4 rounded-xl text-left space-y-1">
          ...
          <p className="text-[10px] text-[var(--ink-dim)]">Aceleração de Hardware GPU Ativa</p>
        </div>
        ...
        <div className="bg-[var(--bg)] border border-[var(--line)]/90 p-4 rounded-xl text-left space-y-1">
          ...
          <p className="text-[10px] text-[var(--ink-dim)]">Cabo Ingest Ininterrupto</p>
        </div>
      </div>

      {/* Recharts Performance Area Chart */}
      <div className="pt-2">
        <span className="text-xs font-bold text-[var(--ink-lo)] uppercase tracking-wider block mb-3">
