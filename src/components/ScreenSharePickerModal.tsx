...
function PhotoshopMock() {
  return (
    <div className="w-full aspect-video bg-[var(--surface)] rounded-lg border border-[var(--line)] overflow-hidden flex flex-col select-none pointer-events-none">
      <div className="bg-[var(--bg)] px-2 py-1 flex items-center justify-between border-b border-[var(--line)]">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-[8px] font-bold text-[var(--text-lo)] ml-1">Photoshop - Poster_Marketing_V6.psd</span>
        </div>
        <span className="text-[7px] text-[var(--text-dim)] font-bold uppercase tracking-wider">PS 2026</span>
      </div>
      <div className="flex-1 flex bg-[var(--panel)]">
        <div className="w-4 bg-[var(--bg)] border-r border-[var(--line)]/60 flex flex-col gap-1 items-center pt-1.5 text-[var(--text-dim)]">
          <div className="w-2.5 h-2.5 bg-blue-500 rounded-sm"></div>
          <div className="w-2 h-2 bg-[var(--panel)] rounded-sm"></div>
          <div className="w-2 h-2 bg-[var(--panel)] rounded-sm"></div>
        </div>
        <div className="flex-1 flex items-center justify-center p-2 relative">
          <div className="w-full h-full bg-[var(--bg)] rounded border border-[var(--line)]/80 flex flex-col items-center justify-center relative overflow-hidden">
        ...
        <div className="w-14 bg-[var(--bg)] border-l border-[var(--line)]/60 p-1.5 flex flex-col gap-1 text-[6px] text-[var(--text-dim)]">
          <div className="border-b border-[var(--line)] pb-1 text-[var(--text-lo)] font-bold">Camadas</div>
    ...
    <div className="w-full aspect-video bg-[var(--surface)] rounded-lg border border-[var(--line)] overflow-hidden flex flex-col select-none pointer-events-none">
      <div className="bg-[var(--bg)] px-2 py-1 flex items-center justify-between border-b border-[var(--line)]">
        <div className="flex items-center gap-1.5">
          ...
          <span className="w-1.5 h-1.5 rounded-full bg-yellow-500"></span>
          <span className="w-1.5 h-1.5 rounded-full bg-green-500"></span>
          <span className="text-[8px] font-bold text-[var(--text-lo)] ml-1">OBS Studio 30.2 - Transmissão Ativa</span>
        </div>
      </div>
      <div className="flex-1 bg-[var(--bg)] flex flex-col p-1.5 gap-1.5">
        <div className="flex-1 bg-[var(--bg)] border border-[var(--line)] flex items-center justify-center relative overflow-hidden">
          <div className="border border-[var(--line)] w-4/5 h-4/5 bg-[var(--surface)] flex items-center justify-center">
            <div className="border border-[var(--line-ctl)] w-3/4 h-3/4 bg-[var(--panel)] flex items-center justify-center">
              <span className="text-[5px] font-mono text-[var(--text-dim)]">Loop Infinito</span>
            </div>
          </div>
        ...
        <div className="h-10 bg-[var(--surface)] border border-[var(--line)] rounded p-1 flex justify-between items-center text-[6px]">
          <div className="space-y-0.5">
            <span className="text-[var(--text-lo)] block font-bold">Cenas</span>
          ...
          <div className="flex-1 mx-2 space-y-0.5">
            <span className="text-[var(--text-lo)] block font-bold text-center">Mixer de Áudio</span>
            <div className="h-1 w-full bg-[var(--bg)] rounded overflow-hidden relative">
          ...
          <div className="flex flex-col gap-0.5 scale-90">
            ...
            <span className="bg-[var(--panel)] text-[var(--text-lo)] px-1 py-0.2 rounded text-[5px] text-center">REC: ATIVO</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="w-full aspect-video bg-[var(--surface)] rounded-lg border border-[var(--line)] overflow-hidden flex flex-col select-none pointer-events-none">
      <div className="bg-[var(--bg)] px-2 py-1 flex items-center justify-between border-b border-[var(--line)]">
        <div className="flex items-center gap-1.5">
          ...
          <span className="w-1.5 h-1.5 rounded-full bg-yellow-500"></span>
          <span className="w-1.5 h-1.5 rounded-full bg-green-500"></span>
          <span className="text-[8px] font-bold text-[var(--text-lo)] ml-1">App.tsx - workspace-podcasting - VS Code</span>
        </div>
      </div>
      <div className="flex-1 flex bg-[var(--surface)]">
        <div className="w-3 bg-[var(--surface)] flex flex-col items-center pt-1.5 gap-1.5 text-[var(--text-dim)] border-r border-[var(--line)]">
          <div className="w-1.5 h-1.5 bg-blue-500 rounded-sm"></div>
          <div className="w-1.5 h-1.5 bg-[var(--raise)] rounded-sm"></div>
        </div>
        <div className="w-14 bg-[var(--surface)] border-r border-[var(--line)] p-1 flex flex-col gap-0.5 text-[5px] text-[var(--text-dim)]">
          <span className="font-bold text-[var(--text-lo)] text-[5px] tracking-wide block truncate uppercase">WORKSPACE</span>
          <span className="text-blue-400 pl-1 font-bold">src/</span>
          <span className="text-amber-500 pl-2">App.tsx</span>
          <span className="text-[var(--text-lo)] pl-2">index.css</span>
        </div>
        <div className="flex-1 bg-[var(--bg)] p-1.5 font-mono text-[5px] text-[var(--text-lo)] leading-normal overflow-hidden">
          ...
          <div className="pl-2 text-[var(--text-lo)]">const <span className="text-blue-300">{"[live, setLive]"}</span> = useState(true);</div>
          ...
          <div className="pl-6 text-[var(--text)]">{"<StudioView />"}</div>
    ...
    <div className="w-full aspect-video bg-[var(--surface)] rounded-lg border border-[var(--line)] overflow-hidden flex flex-col select-none pointer-events-none">
      <div className="bg-[var(--bg)] px-2 py-1 flex items-center justify-between border-b border-[var(--line)]">
        <div className="flex items-center gap-1.5">
          ...
          <span className="w-1.5 h-1.5 rounded-full bg-yellow-500"></span>
          <span className="w-1.5 h-1.5 rounded-full bg-green-500"></span>
          <span className="text-[8px] font-bold text-[var(--text-lo)] ml-1">Apresentação de Vendas.pptx - PowerPoint</span>
        </div>
      </div>
      <div className="flex-1 flex bg-[var(--panel)]">
        <div className="w-10 bg-[var(--surface)] border-r border-[var(--line)] p-1 flex flex-col gap-1 items-center">
          ...
          <div className="w-8 h-4 rounded border border-[var(--line)] bg-[var(--surface)] text-[4px] text-[var(--text-dim)] flex items-center justify-center">Slide 2</div>
          <div className="w-8 h-4 rounded border border-[var(--line)] bg-[var(--surface)] text-[4px] text-[var(--text-dim)] flex items-center justify-center">Slide 3</div>
        </div>
        <div className="flex-1 bg-[var(--surface)] p-2 flex flex-col justify-between">
          <div className="text-center mt-1">
            ...
            <h2 className="text-[9px] font-black text-[var(--text-hi)] mt-0.5">Estratégias de Vendas 2026</h2>
            <p className="text-[5px] text-[var(--text-lo)]">Alcançando novos horizontes</p>
          </div>
...
export function ScreenSharePickerModal({ isOpen, onClose, initialTab = 'pdf', onSelectShare }: ScreenSharePickerModalProps) {
  ...
  const WINDOWS = [
    ...
    { id: 'win-2', name: 'OBS Studio (Transmissão de Alta Performance)', icon: Laptop, color: 'text-[var(--text-lo)]', app: 'OBS Studio' },
  ...
  const SCREENS = [
    { id: 'scr-1', name: 'Tela 1 - Monitor Principal (Apresentação)', icon: Laptop, color: 'text-[var(--text-hi)]' },
  ...
  return (
    <div className="fixed inset-0 z-[150] flex items-center justify-center p-4 bg-black/80 backdrop-blur-md select-none font-sans" id="screen-share-picker-modal">
      ...
      <div className={`w-full ${isExpanded ? 'max-w-5xl h-[600px]' : 'max-w-3xl'} bg-[var(--panel)] border border-[var(--line)] rounded-2xl shadow-2xl text-[var(--text-hi)] flex flex-col overflow-hidden animate-in zoom-in-95 duration-200 transition-all duration-300`}>
        
        {/* Windows Header Tabbar */}
        <div className="bg-[var(--bg)] px-5 py-4 border-b border-[var(--line)]/80 flex items-center justify-between">
          <div className="flex flex-col">
            <h3 className="text-sm font-black text-[var(--text-hi)] flex items-center gap-2">
              <span className="w-2.5 h-2.5 rounded-full bg-blue-500 animate-pulse"></span>
              Escolha o que compartilhar com pwstreamer.com / restream
            </h3>
            <p className="text-[11px] text-[var(--text-lo)] mt-0.5">Selecione uma janela física, guia ou envie um arquivo para apresentação</p>
          </div>
          <button 
            type="button"
            onClick={onClose}
            className="text-[var(--text-lo)] hover:text-[var(--text-hi)] hover:bg-[var(--panel)] p-1.5 rounded-lg transition-all cursor-pointer"
            id="btn-close-picker"
          >
            <X size={18} />
          </button>
          ...
          <div className="bg-blue-600/10 border-b border-blue-500/20 px-5 py-3 flex items-center justify-between gap-4">
            <div className="flex items-center gap-2.5">
              ...
              <p className="text-[11px] text-blue-200 leading-normal">
                ...
                <strong className="text-[var(--text-hi)]"> Segunda Tela (Dual Monitors)</strong> ou janelas reais do seu PC, abra o app em uma aba dedicada.
              </p>
            </div>
            <button
        ...
        {/* Tabs Row */}
        <div className="flex bg-[var(--bg)]/40 border-b border-[var(--line)]/80 px-4 scrollbar-none overflow-x-auto">
          {[
            ...
            return (
              <button
                ...
                className={`py-3.5 px-4 text-xs font-bold relative transition-all cursor-pointer whitespace-nowrap flex items-center gap-1.5 ${
                  isSel ? 'text-blue-400' : 'text-[var(--text-lo)] hover:text-[var(--text-hi)]'
                }`}
        ...
        <div className={`flex ${isExpanded ? 'flex-1' : 'h-[340px]'} bg-[var(--surface)]/40 overflow-hidden transition-all duration-300`}>
          ...
          <div className={`${isExpanded ? 'w-full' : 'w-[320px]'} border-r border-[var(--line)] p-4 overflow-y-auto custom-scrollbar flex flex-col min-h-0 transition-all duration-300`}>
            
            {/* Top controls: Search Bar & Expanded view */}
            <div className="flex flex-col gap-2 mb-3 pb-3 border-b border-[var(--line)]/80 shrink-0">
              {/* Search input */}
              <div className="relative">
                <Search size={14} className="absolute left-2.5 top-2.5 text-[var(--text-lo)]" />
                <input
                  type="text"
                  placeholder="Pesquisar fontes..."
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  className="w-full bg-[var(--bg)] border border-[var(--line)] text-xs text-[var(--text-hi)] placeholder-[var(--text-dim)] rounded-xl pl-9 pr-8 py-2 focus:outline-none focus:border-blue-500 transition-all"
                ...
                {searchQuery && (
                  <button
                    ...
                    className="absolute right-2.5 top-2.5 text-[var(--text-lo)] hover:text-[var(--text-hi)] transition-colors"
                  >
                    <X size={12} />
                  </button>
                )}
            ...
            <div className="flex-1 space-y-2">
                        ...
                        <button
                          ...
                          className={`w-full text-left flex items-start gap-3 px-3 py-2.5 rounded-xl border transition-all cursor-pointer ${
                            isSelected 
                              ...
                              : 'bg-[var(--bg)] hover:bg-[var(--surface)] border-[var(--line)] text-[var(--text)] hover:border-[var(--line-ctl)]'
                          }`}
                          id={`item-tab-${item.id}`}
                        >
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <p className="text-[8px] text-[var(--text-dim)] font-mono mt-0.5">{item.url}</p>
                          </div>
                        </button>
                      );
                    })
                    ...
                    filteredWindows.map((item) => {
                        ...
                        return (
                          <button
                            ...
                            className={`w-full text-left rounded-xl border transition-all cursor-pointer p-2 flex flex-col gap-2 relative group/card ${
                              isSelected 
                                ...
                                : 'bg-[var(--bg)] hover:bg-[var(--surface)] border-[var(--line)] hover:border-[var(--line-ctl)] text-[var(--text)]'
                            }`}
                          ...
                          >
                            ...
                            <div className="px-1.5 py-0.5 flex justify-between items-center w-full shrink-0">
                              <div className="min-w-0 flex-1">
                                <p className={`text-[10px] font-black truncate ${isSelected ? 'text-blue-400' : 'text-[var(--text-hi)]'}`}>{item.name}</p>
                                <p className="text-[8px] text-[var(--text-dim)] font-mono">Software • {item.app}</p>
                              </div>
                              {isSelected ? (
                                ...
                                <span className="w-4 h-4 rounded-full border border-[var(--line-ctl)] group-hover/card:border-slate-500 transition-all shrink-0" />
                              )}
                            </div>
                          </button>
                        );
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="min-w-0 flex-1">
                            <p className="text-[11px] font-bold truncate">{item.name}</p>
                            <p className="text-[8px] text-[var(--text-dim)] font-mono mt-0.5">Software • {item.app}</p>
                          </div>
                        </button>
                      );
                    })
                  ) : (
                    <div className="text-center py-8 text-[var(--text-dim)] w-full col-span-2">
              ...
              {activeTab === 'screen' && (
                <div className="space-y-3">
                  <p className="text-[10px] text-[var(--text-lo)] leading-normal px-1">
                ...
                <div className="space-y-4">
                  ...
                  {(!uploadedFileName && (!searchQuery || "Carregar arquivo PDF Slides".toLowerCase().includes(searchQuery.toLowerCase()))) && (
                    <div 
                      ...
                      className="border-2 border-dashed border-[var(--line-ctl)] hover:border-blue-500/80 bg-[var(--bg)] rounded-xl p-5 text-center transition-all cursor-pointer flex flex-col items-center justify-center gap-2 group"
                      id="dropzone-pdf"
                    >
                      <input 
                        type="file" 
                      ...
                      <p className="text-[11px] font-bold text-[var(--text)]">Arraste ou clique para carregar</p>
                      <p className="text-[8.5px] text-[var(--text-dim)]">Suporta arquivos PDF ou Imagens de Slides</p>
                    </div>
                  )}
                  ...
                  {uploadedFileName ? (
                    (!searchQuery || uploadedFileName.toLowerCase().includes(searchQuery.toLowerCase())) ? (
                      <div className="space-y-4">
                        <div className="p-3 bg-blue-500/5 border border-blue-500/20 rounded-xl space-y-1 text-left relative overflow-hidden">
                          ...
                          <p className="text-[11px] font-bold text-[var(--text-hi)] truncate pr-6">{uploadedFileName}</p>
                          <p className="text-[8px] text-[var(--text-lo)]">12 Slides processados e prontos</p>
                          <button 
                            onClick={(e) => {
                              e.stopPropagation();
                              setUploadedFileName('');
                            ...
                            className="absolute right-2.5 top-2.5 text-[var(--text-lo)] hover:text-[var(--text-hi)]"
                            title="Excluir"
                          >
                            <X size={12} />
                          </button>
                        ...
                        <div className="space-y-3 bg-[var(--bg)] p-3 rounded-xl border border-[var(--line)]">
                          <div className="flex items-center justify-between">
                            <span className="text-[10px] font-bold text-[var(--text-lo)] uppercase tracking-wider">Visualizador de Slides</span>
                          ...
                          <div className="relative w-full aspect-video bg-[var(--bg)] rounded-lg overflow-hidden border border-[var(--line)] flex items-center justify-between p-2 group">
                            {/* Left Arrow Button */}
                            <button
                              type="button"
                              onClick={() => setPdfPreviewPage(prev => Math.max(1, prev - 1))}
                              disabled={pdfPreviewPage === 1}
                              className={`absolute left-2 top-1/2 -translate-y-1/2 p-1.5 rounded-full bg-[var(--surface)]/90 border border-[var(--line)] text-[var(--text-hi)] hover:text-orange-400 hover:border-orange-500/30 transition-all shadow-lg z-10 ${
                            ...
                            <div className="w-full h-full flex flex-col justify-between p-3 select-none text-center">
                              <div className="space-y-1 mt-2">
                                ...
                                <h4 className="text-[11px] font-bold text-[var(--text-hi)] line-clamp-1">
                            ...
                            <button
                              ...
                              className={`absolute right-2 top-1/2 -translate-y-1/2 p-1.5 rounded-full bg-[var(--surface)]/90 border border-[var(--line)] text-[var(--text-hi)] hover:text-orange-400 hover:border-orange-500/30 transition-all shadow-lg z-10 ${
                          ...
                          <div className="space-y-1.5">
                            <span className="text-[8px] text-[var(--text-dim)] font-bold uppercase tracking-wider block px-0.5">Selecione para saltar</span>
                                  ...
                                  <button
                                    ...
                                    className={`flex-shrink-0 w-11 h-11 rounded-lg border text-center flex flex-col justify-center items-center transition-all cursor-pointer relative ${
                                      isSelected 
                                        ...
                                        : 'bg-[var(--bg)]/80 border-[var(--line)] hover:border-[var(--line-ctl)] hover:bg-[var(--surface)]/50'
                                    }`}
                                    title={`Ir para Página ${pageNum}`}
                                  >
                                    <span className={`text-[9px] font-mono font-black ${isSelected ? 'text-orange-400' : 'text-[var(--text-lo)]'}`}>
                                      {pageNum}
                                    </span>
                                    <span className="text-[5px] text-[var(--text-dim)] scale-90 uppercase tracking-tighter">
                                      {pageNum === 1 && "Abert"}
                                      {pageNum === 2 && "Objet"}
                                      {pageNum === 3 && "Mercad"}
                                      {pageNum === 4 && "Métr"}
                    ...
                    (!searchQuery || "Plano de Marketing 2026.pdf Estatísticas Consolidadas Vega6".toLowerCase().includes(searchQuery.toLowerCase())) ? (
                      <button
                        ...
                        className="w-full bg-[var(--bg)] border border-[var(--line)] rounded-xl p-3 text-left hover:border-[var(--line-ctl)] transition-all cursor-pointer flex items-center gap-2.5"
                        id="btn-use-mock-pdf"
                      >
                        <FileText size={15} className="text-amber-500 shrink-0" />
                        <div>
                          <p className="text-[11px] font-bold text-[var(--text-hi)]">Usar PDF de Demonstração</p>
                          <p className="text-[8px] text-[var(--text-dim)]">Estatísticas Consolidadas Vega6</p>
                        </div>
                      </button>
                    ) : (
                      <div className="text-center py-8 text-[var(--text-dim)]">
                ...
                <div className="space-y-4">
                  ...
                  {(!uploadedFileName && (!searchQuery || "Carregar arquivo Vídeo Local MP4 WebM".toLowerCase().includes(searchQuery.toLowerCase()))) && (
                    <div 
                      ...
                      onDrop={handleDrop}
                      onClick={triggerFileInput}
                      className="border-2 border-dashed border-[var(--line-ctl)] hover:border-emerald-500/80 bg-[var(--bg)] rounded-xl p-5 text-center transition-all cursor-pointer flex flex-col items-center justify-center gap-2 group"
                      id="dropzone-video"
                    >
                      <input 
                        type="file" 
                        ...
                        className="hidden" 
                      />
                      <Video size={24} className="text-[var(--text-dim)] group-hover:text-emerald-400 transition-colors" />
                      <p className="text-[11px] font-bold text-[var(--text)]">Arraste ou clique para carregar</p>
                      <p className="text-[8.5px] text-[var(--text-dim)]">Suporta arquivos MP4, WebM ou OGG</p>
                    </div>
                  )}
                  ...
                  {uploadedFileName ? (
                    (!searchQuery || uploadedFileName.toLowerCase().includes(searchQuery.toLowerCase())) ? (
                      <div className="p-3 bg-emerald-500/5 border border-emerald-500/20 rounded-xl space-y-1 text-left relative overflow-hidden">
                        ...
                        <p className="text-[11px] font-bold text-[var(--text-hi)] truncate pr-6">{uploadedFileName}</p>
                        <p className="text-[8px] text-[var(--text-lo)]">Stream dinâmico habilitado</p>
                        <button 
                          onClick={(e) => {
                            e.stopPropagation();
                            setUploadedFileName('');
                    ...
                    (!searchQuery || "Video_Promocional_Empresarial.mp4 Apresentação Institucional Corporativa".toLowerCase().includes(searchQuery.toLowerCase())) ? (
                      ...
                      >
                        ...
                        <div>
                          <p className="text-[11px] font-bold text-[var(--text-hi)]">Usar Vídeo de Demonstração</p>
                          <p className="text-[8px] text-[var(--text-dim)]">Apresentação Institucional Corporativa</p>
                        </div>
                      </button>
                    ) : (
                      <div className="text-center py-8 text-[var(--text-dim)]">
          ...
          <div className="flex-1 p-4 flex flex-col bg-[var(--bg)] relative justify-center items-center">
            {selectedItemId ? (
              <div className="w-full h-full flex flex-col border border-[var(--line)] bg-[var(--bg)] rounded-xl overflow-hidden shadow-inner relative">
                
                {/* Search Bar / Top Ribbon */}
                <div className="bg-[var(--bg)] px-3 py-2 border-b border-[var(--line)]/80 flex items-center justify-between gap-2 shrink-0">
                  <div className="flex items-center gap-1.5 overflow-hidden">
                    <span className="w-2 h-2 rounded-full bg-red-500 shrink-0"></span>
                    <span className="text-[9px] font-bold text-[var(--text-lo)] truncate max-w-[180px]">
                      {getSelectedItemName()}
                    </span>
                  </div>
                ...
                <div className="flex-1 bg-[var(--bg)]/80 p-4 flex flex-col justify-center items-center text-center relative overflow-hidden">
                  ...
                  {selectedItemId === 'tab-2' && (
                    <div className="space-y-2 w-full max-w-[200px]">
                      ...
                      <p className="text-[11px] font-bold text-[var(--text-hi)] leading-tight">PwStreamer - Estúdio Ao Vivo</p>
                      <p className="text-[8px] text-[var(--text-lo)] leading-normal">Hospede webinars corporativos e lives profissionais em tempo real.</p>
                  ...
                  {selectedItemId === 'tab-3' && (
                    <div className="space-y-2 w-full max-w-[200px]">
                      ...
                      <p className="text-[11px] font-bold text-[var(--text-hi)] leading-tight">PL da Misoginia: entenda os impactos reais</p>
                      <p className="text-[8px] text-[var(--text-lo)]">Vega6 TV • Transmissão Ativa</p>
                    </div>
                  )}
                  ...
                  {selectedItemId === 'tab-6' && (
                    <div className="w-full max-w-[220px] text-left text-[8px] space-y-1.5">
                      <div className="flex items-center justify-between font-bold text-[var(--text)] border-b border-[var(--line)] pb-1.5">
                        <span className="flex items-center gap-1">📥 Caixa de Entrada</span>
                        <span className="text-red-400">237 Novas</span>
                      </div>
                      <div className="bg-[var(--surface)] p-1.5 rounded border border-[var(--line)] truncate text-[var(--text)]">
                        <strong className="text-[var(--text-hi)]">Marcos:</strong> Confirmado o webinar hoje às 20h.
                      </div>
                      <div className="bg-[var(--surface)] p-1.5 rounded border border-[var(--line)] truncate text-[var(--text)]">
                        <strong className="text-[var(--text-hi)]">Felipe:</strong> Adorei o layout do estúdio.
                      </div>
                    </div>
                  )}
                  ...
                  {selectedItemId === 'win-4' && (
                    <div className="space-y-2.5 w-full max-w-[220px] text-center">
                      <p className="text-[11px] font-black text-[var(--text-hi)]">Powerpoint - Apresentação de Vendas.pptx</p>
                      <div className="grid grid-cols-3 gap-1 px-1">
                        <div className="h-7 bg-[var(--surface)] border border-[var(--line)] rounded text-[7px] flex items-center justify-center text-[var(--text-dim)]">Slide 1</div>
                        ...
                        <div className="h-7 bg-[var(--surface)] border border-[var(--line)] rounded text-[7px] flex items-center justify-center text-[var(--text-dim)]">Slide 3</div>
                      </div>
                    </div>
                  )}
                  ...
                  {(selectedItemId === 'scr-1' || selectedItemId === 'scr-2') && (
                    <div className="space-y-2.5 w-full max-w-[220px]">
                      <div className="text-[var(--text-lo)] text-2xl">🖥️</div>
                      <p className="text-[11px] font-black text-[var(--text-hi)] leading-tight">
                        {selectedItemId === 'scr-1' ? 'Monitor 1 (Principal)' : 'Monitor 2 (Monitor Lateral)'}
                      </p>
                      <p className="text-[8px] text-[var(--text-dim)]">
                      ...
                      <div className="flex gap-1.5 justify-center">
                        <span className="text-[7px] bg-[var(--panel)] text-[var(--text-lo)] px-1.5 py-0.5 rounded font-mono">1920x1080</span>
                    ...
                    <div className="w-full h-full flex flex-col justify-between p-4 bg-gradient-to-br from-[var(--bg)] to-[var(--well)] rounded-xl text-left border border-orange-500/10 overflow-hidden min-h-0">
                      <div className="flex justify-between items-center border-b border-orange-500/20 pb-2 mb-2 shrink-0">
                        <div className="flex items-center gap-1.5 overflow-hidden">
                          ...
                          <span className="text-[10px] font-bold text-[var(--text-hi)] truncate max-w-[120px]">{uploadedFileName || 'Plano_de_Marketing_2026.pdf'}</span>
                        </div>
                      ...
                      <div className="flex-1 bg-[var(--bg)]/70 border border-[var(--line)]/80 rounded-lg p-3 flex flex-col justify-center text-center space-y-2 relative group overflow-hidden min-h-0">
                        <button 
                          ...
                          onClick={() => setPdfPreviewPage(prev => Math.max(1, prev - 1))}
                          disabled={pdfPreviewPage === 1}
                          className={`absolute left-2 top-1/2 -translate-y-1/2 p-1.5 rounded-full bg-[var(--panel)]/80 hover:bg-[var(--raise)] text-[var(--text-hi)] transition-all shadow z-10 ${
                        ...
                        <button 
                          ...
                          onClick={() => setPdfPreviewPage(prev => Math.min(12, prev + 1))}
                          disabled={pdfPreviewPage === 12}
                          className={`absolute right-2 top-1/2 -translate-y-1/2 p-1.5 rounded-full bg-[var(--panel)]/80 hover:bg-[var(--raise)] text-[var(--text-hi)] transition-all shadow z-10 ${
                        ...
                        <div className="space-y-1 animate-in fade-in duration-150">
                          ...
                          <h3 className="text-[11px] font-black text-[var(--text-hi)] tracking-tight leading-snug">
                            {pdfPreviewPage === 1 && "Estratégia de Expansão Global Vega6"}
                            {pdfPreviewPage === 2 && "Maximização de Engajamento & Retenção"}
                            {pdfPreviewPage === 3 && "Análise Demográfica do Público-Alvo"}
                            {pdfPreviewPage === 4 && "Resultados e Métricas Trimestrais"}
                          ...
                          <p className="text-[9px] text-[var(--text-lo)] max-w-md mx-auto leading-normal">
                      ...
                      <div className="text-[8px] text-[var(--text-dim)] text-center font-mono uppercase tracking-wide shrink-0">
                    ...
                    <div className="w-full h-full flex flex-col justify-between p-4 bg-gradient-to-br from-[var(--bg)] to-[var(--well)] rounded-xl text-left border border-emerald-500/10 overflow-hidden min-h-0">
                      <div className="flex justify-between items-center border-b border-emerald-500/20 pb-2 mb-2 shrink-0">
                        <div className="flex items-center gap-1.5 overflow-hidden">
                          ...
                          <span className="text-[10px] font-bold text-[var(--text-hi)] truncate max-w-[150px]">{uploadedFileName || 'Apresentação_Institucional.mp4'}</span>
                        </div>
                      ...
                      {uploadedFileUrl ? (
                        <div className="flex-1 bg-black rounded-lg relative overflow-hidden flex flex-col justify-center min-h-0 group border border-[var(--line)]">
                          {/* Video Tag */}
                          <video
                            ref={videoRef}
                            src={uploadedFileUrl}
                          ...
                          <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/95 via-black/80 to-transparent p-2.5 flex flex-col gap-1.5 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300 z-10">
                            ...
                            <div className="flex items-center gap-2">
                              <input
                                ...
                                className="w-full h-1 bg-[var(--panel)] rounded-lg appearance-none cursor-pointer accent-emerald-500 hover:accent-emerald-400"
                              />
                            </div>
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-3">
                                ...
                                <button
                                  type="button"
                                  onClick={togglePlay}
                                  className="text-[var(--text-hi)] hover:text-emerald-400 transition-colors p-1 bg-[var(--surface)]/60 rounded-full cursor-pointer"
                                ...
                                <button
                                  type="button"
                                  onClick={toggleMute}
                                  className="text-[var(--text)] hover:text-emerald-400 transition-colors p-1 cursor-pointer"
                                ...
                                {/* Time display */}
                                <span className="text-[9px] font-mono font-medium text-[var(--text)] select-none">
                                  {formatVideoTime(videoCurrentTime)} / {formatVideoTime(videoDuration)}
                                </span>
                              </div>

                              <span className="text-[7px] font-mono text-[var(--text-dim)] uppercase tracking-widest bg-[var(--bg)] px-1.5 py-0.5 rounded border border-[var(--line)]">
                                player ativo
                              </span>
                            </div>
                          </div>
                        ...
                        <div className="flex-1 border border-dashed border-[var(--line)] rounded-lg flex flex-col items-center justify-center text-center p-4 bg-[var(--bg)]/40">
                          <div className="w-10 h-10 rounded-full bg-[var(--surface)] flex items-center justify-center border border-[var(--line)] text-[var(--text-dim)] mb-2">
                            <Video size={16} />
                          </div>
                          <p className="text-[10px] font-bold text-[var(--text)]">Nenhum vídeo selecionado</p>
                          <p className="text-[8px] text-[var(--text-dim)] max-w-[160px] mt-1 leading-normal">Carregue um clipe local ou selecione o vídeo de demonstração ao lado para pré-visualizar.</p>
                        </div>
                      )}

                      <div className="text-[8px] text-[var(--text-dim)] text-center font-mono uppercase tracking-wide shrink-0 mt-2">
                  ...
                  {![ 'tab-2', 'tab-3', 'tab-6', 'win-4', 'scr-1', 'scr-2' ].includes(selectedItemId) && activeTab !== 'pdf' && activeTab !== 'video' && (
                    <div className="space-y-1.5">
                      <div className="text-[var(--text-dim)] text-xl">🖥️</div>
                      <p className="text-[11px] font-bold text-[var(--text-hi)] truncate max-w-[180px] mx-auto">{getSelectedItemName()}</p>
                      <p className="text-[8px] text-[var(--text-dim)]">Transmissão em tempo real ativa disponível.</p>
                    </div>
                  )}
                ...
                <div className="bg-[var(--bg)] px-3 py-1.5 border-t border-[var(--line)]/80 text-[8px] text-[var(--text-dim)] text-center uppercase tracking-wider font-bold">
                  Clique em Compartilhar para transmitir para o Estúdio
                </div>

              </div>
            ) : (
              <div className="w-full h-full border border-dashed border-[var(--line)] rounded-2xl flex flex-col items-center justify-center text-center p-6 bg-[var(--bg)]/30">
                <div className="w-12 h-12 rounded-full bg-[var(--surface)] flex items-center justify-center text-[var(--text-dim)] border border-[var(--line)] mb-3">
                  <Monitor size={20} />
                </div>
                <p className="text-xs font-bold text-[var(--text)]">Selecione uma opção ao lado</p>
                <p className="text-[10px] text-[var(--text-dim)] max-w-[180px] mt-1.5 leading-normal">
        ...
        {/* Footer controls */}
        <div className="bg-[var(--bg)] px-6 py-4 border-t border-[var(--line)] flex flex-wrap items-center justify-between gap-4">
          
          <div className="flex flex-wrap items-center gap-5">
            {/* Audio toggle */}
            <label className="flex items-center gap-2.5 cursor-pointer text-[var(--text-lo)] hover:text-[var(--text-hi)] transition-all shrink-0">
              <input
                type="checkbox"
                checked={audioShared}
                onChange={(e) => setAudioShared(e.target.checked)}
                className="w-4 h-4 rounded border-[var(--line-ctl)] bg-[var(--panel)] text-blue-500 focus:ring-0 cursor-pointer"
                id="chk-share-audio"
              />
            ...
            {/* Separator */}
            <div className="h-6 w-[1.5px] bg-[var(--panel)] hidden md:block" />

            {/* Capture Quality Options */}
            <div className="flex flex-wrap items-center gap-4">
              <div className="flex flex-col gap-0.5">
                <span className="text-[8px] text-[var(--text-dim)] font-extrabold uppercase tracking-wider">Resolução</span>
                <div className="flex bg-[var(--bg)]/80 rounded-lg p-0.5 border border-[var(--line)]/80">
                  <button
                    type="button"
              ...
              <div className="flex flex-col gap-0.5">
                <span className="text-[8px] text-[var(--text-dim)] font-extrabold uppercase tracking-wider">Taxa de Quadros</span>
                <div className="flex bg-[var(--bg)]/80 rounded-lg p-0.5 border border-[var(--line)]/80">
                  <button
                    type="button"
          ...
          <div className="flex items-center gap-2.5">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 rounded-xl text-xs font-bold text-[var(--text-lo)] hover:text-[var(--text-hi)] hover:bg-[var(--panel)] transition-all border border-[var(--line)] cursor-pointer"
            ...
            <button
              ...
              className={`px-5 py-2 rounded-xl text-xs font-bold text-white transition-all cursor-pointer ${
                selectedItemId 
                  ...
                  : 'bg-[var(--panel)] text-[var(--text-dim)] cursor-not-allowed'
              }`}
